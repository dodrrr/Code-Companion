#!/usr/bin/env python3
"""Apply Chain experience v4 over the reviewed clarity v3 base."""
import argparse
import hashlib
import json
import os
...
def main():
    ...
    print('La copia guarda código, no datos de Expo. V4 migra Chains y Plan: lee MIGRACION-Y-DATOS.md antes de abrirla; después no vuelvas a v3 solo restaurando código.')
    return 0
