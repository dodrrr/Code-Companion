...
import { CHAIN_COLOR_NAMES, EXTRA_CHAIN_COLORS } from '@/constants/colors';
  ...
  return (
    <AmbientScreen tone="plan" style={styles.root}>
            ...
            {showInput ? (
              <>
                ...
                <ComposerMeta
                  ...
                  allowPriority
                  priorityDayLabel={isToday ? 'today' : isTomorrow ? 'tomorrow' : 'that day'}
      ...
      <PlanCalendar
        ...
        chainColors={Object.fromEntries(chains.map((chain) => [chain.id, chain.color]))}
...
function ComposerMeta({ colors, chains, selectedChainId, setSelectedChainId, selectedTaskColor, setSelectedTaskColor, selectedTime, setSelectedTime, openTimePicker, selectedReminder, setSelectedReminder, allowPriority, priorityDayLabel, isPriority, setIsPriority, repeatDays, setRepeatDays, selectedDuration, setSelectedDuration, showAdvancedOptions, setShowAdvancedOptions }: any) {
...
function PlanItemRow({ item, chainName, highlighted, newlyAdded, reminderSyncing, isLast, locked, completionLocked, isTomorrow, onToggle, onEdit, onMore }: { item: PlanItem; chainName?: string; highlighted: boolean; newlyAdded: boolean; reminderSyncing: boolean; isLast: boolean; locked: boolean; completionLocked: boolean; isTomorrow: boolean; onToggle: () => void; onEdit: () => void; onMore: () => void }) {
  const colors = useColors();
  const reduceMotion = useReducedMotion();
