...
const styles = StyleSheet.create({
  ...
  detailsToggle: { flexDirection: 'row', alignItems: 'center', gap: 10, borderWidth: 1, borderRadius: 16, padding: 10, marginHorizontal: 16, marginTop: 4 },
  detailsStack: { gap: 5, paddingTop: 2 },
